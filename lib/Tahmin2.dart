...
class Tahmin2 extends StatefulWidget {
  @override
  _Tahmin2State createState() => _Tahmin2State();
}

class _Tahmin2State extends State<Tahmin2> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              Padding(
                padding:  EdgeInsets.all(yukseklik / 10),
                child: Text("İpucu : $ipucu",style: TextStyle(
