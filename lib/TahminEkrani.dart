...
import 'package:snack_bar/Sonuc.dart';

class TahminEt extends StatefulWidget {
  @override
  _TahminEtState createState() => _TahminEtState();
}

class _TahminEtState extends State<TahminEt> {
